        ...
        <footer className="bg-[#0b1c1e] text-white pt-8 pb-4 px-4 border-t border-teal-900">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
                ...
                <div className="flex gap-5">
                    <a href="https://github.com/TylerNL/InvestAnalytics" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-[#FFD052] transition-colors">
                    ...
                    <a href="https://www.instagram.com/investanalyticsofficial/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-[#FFD052] transition-colors">
